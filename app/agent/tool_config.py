...
TOOL_CONFIG = {
    "adr": {
        ...
        "temperature": 0.1,
        "tags": ["use_case:adr"],
        "gate": {"min_docs": 2, "min_unique_sources": 2, "min_score": 0.75},
    ...
    "solution_outline": {
        ...
        "gate": {"min_docs": 3, "min_unique_sources": 2, "min_score": 0.75},
    ...
    "user_stories": {
        ...
        "gate": {"min_docs": 2, "min_unique_sources": 1, "min_score": 0.75},
